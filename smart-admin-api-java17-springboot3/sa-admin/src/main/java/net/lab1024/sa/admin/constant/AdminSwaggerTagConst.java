...
public class AdminSwaggerTagConst extends SwaggerTagConst {
    ...
    public static class SPD {
        public static final String SPD_DEPT_CATEGORY = "SPD-科室分类管理";
        public static final String SPD_WAREHOUSE = "SPD-仓库管理";
        public static final String SPD_MATERIAL = "SPD-耗材管理";
        public static final String SPD_SUPPLIER = "SPD-供应商管理";
        public static final String SPD_MANUFACTURER = "SPD-生产厂家管理";
        public static final String SPD_PURCHASE = "SPD-采购管理";
        public static final String SPD_RECEIVE = "SPD-收货管理";
        public static final String SPD_ACCEPTANCE = "SPD-验收管理";
        public static final String SPD_STOCK = "SPD-库存管理";
        public static final String SPD_APPLY = "SPD-科室请领管理";
        public static final String SPD_DEPT_CONSUME = "SPD-科室消耗管理";
        public static final String SPD_EXPIRY = "SPD-库存效期监控";
        public static final String SPD_LABEL_TRACK = "SPD-标签追溯";
        public static final String SPD_PACKAGE = "SPD-散货打包";
        public static final String SPD_UNPACK = "SPD-定数包拆包";
    }
